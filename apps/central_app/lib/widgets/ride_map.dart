...
enum MarkerKind { pickup, dropoff, driver, car, passenger }
  ...
  Marker _buildMarker(MapMarker marker) {
    ...
    return Marker(
      ...
      width: switch (marker.kind) {
        MarkerKind.car || MarkerKind.driver => 38,
        MarkerKind.passenger => 32,
        MarkerKind.pickup => 32,
        MarkerKind.dropoff => 32,
      },
      ...
      child: switch (marker.kind) {
        ...
        // Passageiro: pino azul royal com silhueta (monitoramento).
        MarkerKind.passenger => Image.asset(
            'assets/markers/pin_passenger.png',
            fit: BoxFit.contain,
          ),

...
3. **Confirmacao** — comparacao de categorias (Moto, Ride, Comfort, Black, Van) com preco,
   ETA e distancia; escolha da forma de pagamento.
4. **Pareamento** — tela de busca com pulso animado, progresso por etapas e PIN de embarque.
...
`react-native-maps`, defina `GOOGLE_MAPS_ANDROID_KEY` e troque o componente (a interface de
props e a mesma).
